...
from f1tenth.f1tenth_gym import RaceCar
from f1tenth.Utils.utils import *
from f1tenth.DatasetTools.PurePursuitDataGen import PurePursuitDataGen
...
def generate_pp_data():
    ...
    if not os.path.exists(experiment.folder): os.makedirs(experiment.folder)
